      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Check your email to reset password!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1000);
            }
...
var resetPassword = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(password, passwordConfirm, resetToken) {
    var res;
...
var stripe = Stripe('pk_test_51LqK9oJG5DQgYgZHt2xcG5PdWytCy9FGRFUmchk5aasy0CcaTiCFJUgV8uxXaYGi6cVHhnJQde8H94zuHhto5vNN00hzop1cvP');
...
var forgotPasswordForm = document.querySelector('.form.form--forgotpassword');
